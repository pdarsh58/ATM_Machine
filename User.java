...
public class User {
	...
	public User (String first_name, String last_name, String pin, mybank _Bank) {
		...
		this.accounts = new ArrayList<user_account>();
	...
	public void addAccount(user_account anAcct) {
